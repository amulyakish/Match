...
//initializing parse
Parse.initialize("V3JaKrEOPtddyVtpW1394agmTq3A4K4m2k34uT5c", "LZObJhHJIymr8K7eqbluufLW8dowaJanp7J0FyKn");
...
exports.showOfferDesc = function(req,res,next){
    console.log("showOfferDesc");
    var id = req.params.offerId;
    var ngoId = req.params.ngoId;
    console.log("----"+ id + "----" + ngoId);
    // offerId and ngoId interchanged for some reason
    var query = new Parse.Query("Opportunity"); //todo check
    var file;
    var object;
    var self = this;
    query.equalTo("objectId", ngoId);
    query.find().then(
        function (data)
...
exports.findAllNGOOffers = function (req, res, next) {
    console.log("findAllNGOOffers");
    var ngoId = req.params.ngoId;
    console.log("---"+ngoId);
    var name = req.query.name;
    var opps = Parse.Object.extend("Opportunity");
    //
    var Ngo= Parse.Object.extend("NGO");
    var ngo1= new Ngo();
    ngo1.id=ngoId;
    //
    var query = new Parse.Query(opps);
    query.include("ngo");
    var file;
    var object;
    var self = this;
    query.equalTo("ngo", ngo1);
    if (name)
        query.equalTo("offerTitle", name);
    query.find({
            success: function (list) {
                console.log("read list of length: " + list.length);
            }
        }
    ).then(function (data) {
            console.log("data: " + data);
...
exports.findAllNGOs = function (req, res, next) {
    var name = req.query.name;
    if (name) {
...
exports.findById = function (req, res, next) {
    ...
    var id = req.params.ngoId;
    // offerId and ngoId interchanged for some reason
    var query = new Parse.Query("NGO"); //todo check
    var file;
    var object;
    var self = this;
...
exports.bookNow = function (req, res, next) {
    console.log("bookNow");
